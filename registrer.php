...
$find_user = "SELECT * FROM login WHERE username='$userName'";
$find_email = "SELECT * FROM login WHERE email='$email'";
...
if($flag == true){
    ...
    $sql ="INSERT INTO login(username, pass, email) values('$userName', '$hashed', '$email')";
        ...
        <div class="row justify-content-center align-items-center" style="height:80vh">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <h3 class="loginheader">Registrer</h3>
                            <label class="float-left" for="email">Email</label>
                                <input placeholder="" Required type="email" class="form-control" name="email" id="email" value="<?php echo isset($_POST['email']) ? $email : ''; ?>" >
                            </div>
                            <div class=" form-group">
                            <label class="float-left" for="username">Brugernavn</label>
                                <input placeholder="" Required type="name" class="form-control" name="username" id="username" value="<?php echo isset($_POST['username']) ? $userName : ''; ?>">
                            </div>
                            <div class=" form-group">
